<?php	
	...
	/* $MonthRecored = array_reverse($MonthRecored);
...
<div id="expertpanel">
	<div class="head-title-bg">
		<div class="crumb">
			<a href="truth-junction-member-index.php"><strong>My Page</strong></a>&nbsp;&raquo; Payment History
		</div>
	</div>
...
<table  cellpadding="0" cellspacing="0" border="0" align="center" class="pad-left">
			...
			<td colspan="3" valign="top" class="round-box-bg-inner">
				<div class="round-box-t-inner">
					<div class="pad8"><h2>Payment History</h2>
					...
					<div class="table-block">
						<table width="100%">
							...
							<tr>
								...
								<th class="head1" align="center">Total Paid</th>
							</tr>
							</thead>
							<?
							if(count($MonthRecored) > 0)
