<?php	
	...
	$query="select * from ".$tblpref."content_master where cms_id=32"; 
...
<div id="expertpanel">
			...
			<?
				$mass = explode(".", $row_add[cms_desc]);
					for($i=0;$i<=2;$i++)
						{
							echo stripslashes($mass[$i]) .".";
						}
				?>.....			
			<p class="more1"><a href="truth-junction-content.php?cid=32">Read more</a></p>
			<p>&nbsp;</p>
                   	  ...
                   	  <td valign="top" class="round-box-bg">
                       	<div class="round-box-t">
                                <div class="pad8">
                                    ...
                                    <div class="services">
										<ul>
											<li class="icon-unemployment"><a href="javascript:servfunc(1);" >Business ideas</a></li>
											<li class="icon-opportunities"><a href="javascript:servfunc(2);">Franchise opportunities</a></li>
											<li class="icon-financial"><a href="javascript:servfunc(3);">Financial services (where to get funds)</a></li>
											<li class="icon-marketing"><a href="javascript:servfunc(4);">Marketing tips and strategies</a></li>
											<li class="icon-life"><a href="javascript:servfunc(5);">Start up procedures</a></li>
											<!--<li class="icon-relation"><a href="javascript:servfunc(6);">Relationships</a></li>
											<li class="icon-family"><a href="javascript:servfunc(7);">Family Planning</a></li>
											<li class="icon-daily-life"><a href="javascript:servfunc(8);">Daily Life</a></li>-->
										</ul>
