<?php	
	...
	index_header('Member Registration');
?>
<div class="head-title-bg">
	<div class="crumb">
	<a href="index.php"><strong>Home</strong></a>&nbsp;&raquo; Member Registration
	</div></div>

	<div style="width:696px;" class="chk">
		<table  cellpadding="0" cellspacing="0" border="0" align="center" class="pad-left">
			...
			<td colspan="3" valign="top" class="round-box-bg-inner">
				<div class="round-box-t-inner">
					<div class="pad8"><h2>Member Registration</h2>
					...
					<tr>
						...
						<select name="ddtitle" id="ddtitle" class="regist" onchange="titlegender(this.id); empty(this.id);" >
					...
					<tr>
						...
						<td><input type="text" name="txtfname" id="txtfname" value="" class="regist" onchange="empty(this.id);">
						<br><label id='etxtfname' class='warning'></label></td>
					</tr>
					<tr>
						<td>Surname : <FONT COLOR="#FF0000">*</FONT></td><td>
						<input type="text" name="txtsname" id="txtsname" value="" class="regist" onchange="empty(this.id);">
					...
					<tr>
						...
						<tr>
						<td align="left">
						<input type="radio" name="radgender" id="radmale" value="Male" checked>&nbsp;Male
						&nbsp;&nbsp;&nbsp;<input type="radio" name="radgender" id="radfemale" value="Female">&nbsp;Female
						</td>
						<td width="30%">&nbsp;</td>
						</tr>
						</table>
					...
					<tr>
						...
						<textarea name="txtpaddress" id="txtpaddress" rows="6" cols="20" onchange="empty(this.id);" class="regist"></textarea>
						<br><label id='etxtpaddress' class='warning'></label></td>
					</tr>

					<tr>
						<td>Phone No. : <FONT COLOR="#FF0000">*</FONT></td><td>
						<input type="text" name="txtphone" id="txtphone" value="" class="regist" onchange="empty(this.id);">
						<br><label id='etxtphone' class='warning'></label></td>
					</tr>

					<tr>
						<td>Cell No. : <FONT COLOR="#FF0000">*</FONT></td><td>
						<input type="text" name="txtcel" id="txtcel" value="" class="regist" onchange="empty(this.id);">
					...
					<tr>
						...
						<input type="text" name="email" id="email" class="regist" onblur="validateemail(this.value,this.id);">
					...
					<tr>
						...
						<input type="text" name="cemail" id="cemail" class="regist" onblur="validateemail1(this.value,this.id);">
						<br><label id='ecemail' class='warning'></label></td>
					</tr>

					<tr>
						<td>Password : <FONT COLOR="#FF0000">*</FONT></td><td>
						<input type="password" name="password" id="password" class="regist" onchange="empty(this.id);">
						<br><label id='epassword' class='warning'></label></td>
					</tr>

					<tr>
						<td>Re-Enter Password : <FONT COLOR="#FF0000">*</FONT></td><td>
						<input type="password" name="rpassword" id="rpassword" class="regist" onblur="validatpass(this.value,this.id);">
						<br><label id='erpassword' class='warning'></label></td>
					</tr>

					<tr>
						<td>Security Question : <FONT COLOR="#FF0000">*</FONT></td>
						<td>
					...
					<tr>
						...
						<input type="text" name="answer" id="answer" class="regist" onchange="empty(this.id);">
					...
					<tr>
						...
						<table width="70%" style="border:#A2A2A2 solid 1px; margin:20px; padding:10px;">
					<tr>
						<td width="40%">Keyword Member Search : </td>
						<td>
						<input type="text" name="kmem" id="kmem" class="regist" onblur="valmemref(this.value,this.id);">
					...
					<tr>
						...
						<table width="70%" style="border:#A2A2A2 solid 1px; margin:20px; padding:10px;">
						<tr>
						<td>Account Name :</td><td><input type="text" name="AccountName" id="AccountName" onchange="empty(this.id);" class="regist">
						</td>
						</tr>
						<tr>
						<td>Account Number :<FONT COLOR="#FF0000">*</FONT></td><td><input type="text" name="AccountNo" id="AccountNo" onchange="empty(this.id);" class="regist">
						<br><label id='eAccountNo' class='warning'></label></td>
						</tr>
						<tr>
						<td>Bank Name :<FONT COLOR="#FF0000">*</FONT></td><td><input type="text" name="BankName" id="BankName" onchange="empty(this.id);" class="regist">
						<br><label id='eBankName' class='warning'></label></td>
						</tr>

						<tr>
						<td>Bank Code :<FONT COLOR="#FF0000">*</FONT></td><td><input type="text" name="Bankcode" id="Bankcode" onchange="empty(this.id);" class="regist">
						<br><label id='eBankcode' class='warning'></label></td>
						</tr>

						<tr>
						<td>Branch Name :<FONT COLOR="#FF0000">*</FONT></td><td><input type="text" name="BranchName" id="BranchName" onchange="empty(this.id);" class="regist">
						<br><label id='eBranchName' class='warning'></label></td>
						</tr>

						<tr>
						<td>Branch Code :<FONT COLOR="#FF0000">*</FONT></td><td><input type="text" name="BranchCode" id="BranchCode" onchange="empty(this.id);" class="regist">
					...
					<tr>
						<td>Contact SMS : </td>
						<td><input type="checkbox" name="chkcontactsms" value="yes"  onchange="chechsms('<?=$rowsubfee[subfee_contactfee]?>','<?=$rowsubfee[subfee_subfees]?>');" checked>
...
{
	document.frmregistration.refid.value=val;
}
