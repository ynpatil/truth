<?php	
	...
	index_header('My Expert Service');
?>
<div id="expertpanel">
		...
		<table  cellpadding="0" cellspacing="0" border="0" align="center" class="pad-left">
			...
			<td colspan="3" valign="top" class="round-box-bg-inner">
				<div class="round-box-t-inner">
					...
					<div class="button-curve" style="float:right; padding-top:10px;"><a href="expert-post-services.php?TB_iframe=true&height=520&width=700" class="thickbox"><span>Post Your Service</span></a></div>
