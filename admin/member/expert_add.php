			...
			<td colspan="3" valign="top" class="round-box-bg-inner">
				<div class="round-box-t-inner">
					...
					<tr>
						...
						<a id="example2" href="../../tjtmp/<?php echo $row_add['mem_upload']; ?>">
						<img src="../../tjtmp/<?php echo $row_add['mem_upload']; ?>" border="0" height="25" width="25" /></a>  <span class="style1">Click on Image</span>            	
						<? } ?>
						</td>
					</tr>
					</table>
					...
					<input style="background:#FCA108; float:right; color:white; border:1px #FCA108 solid;" type="submit" name="submit" value="Update">
					</td></tr>
					</table>
					</td>
					</tr>
