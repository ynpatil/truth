...
include("../../common/config.php");
	...
	echo "\"".$tabsp." \"\r\n";
	echo "\""."Member ID".$tabsp."Member Name".$tabsp."Gender".$tabsp."Date Of Birth".$tabsp."Date Of Registration".$tabsp."Postal address".$tabsp."Phone No".$tabsp."Cell No".$tabsp."Email Address".$tabsp."Password".$tabsp."Referrer Name".$tabsp."Account Name".$tabsp."Account Number".$tabsp."Bank Name".$tabsp."Bank Code".$tabsp."Branch Name".$tabsp."Branch Code".$tabsp."Contact SMS".$tabsp."Status \"\r\n";
