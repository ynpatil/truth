...
<tr>
	...
	<tr><td>
			...
			<tr>
			<th colspan="2" align="center">View Services Posting</th>
			</tr>
			...
			<INPUT TYPE="button" value="Close" Name="Close" class="mybutton" onclick="javascript:window.location.href='index.php';">&nbsp;&nbsp;</td>
			</tr>
		</form>
		</table>
