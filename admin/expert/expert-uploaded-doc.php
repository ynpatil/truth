...
<tr>
			<td colspan="3"><a href="index.php" target="_parent">Back</a>
			</td>
</tr>
			<tr>
			<td colspan="3" valign="top" class="round-box-bg-inner">
				<div class="round-box-t-inner">
					<div class="pad8"><h2>Service Name:: <?=$_REQUEST[name]?></h2>
					<? if($flag=="add") { ?>
					<table>
					...
					?>
						<tr class="light" height="30">
							...
							<strong>Download</strong></a>&nbsp;&nbsp;|&nbsp;<a href="submit_expert.php?id=<?=$row_category[esdoc_id]?>&name=<?=$_REQUEST[name]?>&mode1=del1&expid=<?=$row_category[esdoc_service_id]?>">
