...
if($_SESSION[username]=="")
{
	...
	if($txtdate!="")
	{
		...
		if($datep[1]=="TO")
		{
			$datep1=dateformate($datep[0])." 24:00:00";
			$datep2=dateformate($datep[2])." 24:00:00";
...
admin_header("../../","Payment Received in Selected month");
admin_nav("../../");
?>
...
<table cellspacing="3" cellpadding="0" border="0" width="100%" align="center"  valign="top" class="tbborder">
	<tr><td align="center"><b><h2>Reports: Payment Received in Selected month</h2></b></td></tr>
    <TR>
